 ...
 * <p/>
 * Utility class, which helps to configure {@link javax.net.ssl.SSLEngine}.
...
public class SslEngineConfigurator {
    ...
    /**
     * Create and configure {@link javax.net.ssl.SSLEngine}, based on current settings.
     *
     ...
     * @return {@link javax.net.ssl.SSLEngine}.
     */
