...
/**
 * Writes and reads data to and from a socket. Only one {@link #write(java.nio.ByteBuffer, org.glassfish.jersey.jdk.connector.CompletionHandler)}
...
class TransportFilter extends Filter <ByteBuffer, ByteBuffer, Void, ByteBuffer>{
    ...
    /**
     * {@link org.glassfish.jersey.jdk.connector.ThreadPoolConfig} current {@link #channelGroup} has been created with.
     */
    ...
    private void _read(final ByteBuffer inputBuffer) {
        ...
        socketChannel.read(inputBuffer, null, new CompletionHandler<Integer, Void>() {
            ...
            public void failed(Throwable exc, Void result) {
                /**
                 * Reading from the channel will fail if it is closing. In such cases {@link java.nio.channels.AsynchronousCloseException}
    ...
    /**
     * A default thread factory that gets used if {@link org.glassfish.jersey.jdk.connector.ThreadPoolConfig#getThreadFactory()} is not specified.
     */
