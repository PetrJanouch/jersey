...
public class AsynchronousBodyOutputStreamTest {
    ...
    public void testUnsupportedSync() {
        ...
        assertUnsupported(new Callable() {
            @Override
    ...
    private void doTestSyncWrite(final boolean useArray) throws IOException, InterruptedException, TimeoutException, ExecutionException {
    ...
    private void doTestSyncWriteWithDelay(final boolean useArray) throws IOException, InterruptedException, TimeoutException, ExecutionException {
        ExecutorService executor = Executors.newSingleThreadExecutor();
    ...
    private static class TestWriteListener implements WriteListener {
        ...
        private final AsynchronousBodyOutputStream outputStream;
        ...
        TestWriteListener(AsynchronousBodyOutputStream outputStream) {
            this(outputStream, -1);
        }

        TestWriteListener(AsynchronousBodyOutputStream outputStream, int outputArraySize) {
    ...
    private static class TestStream extends AsynchronousBodyOutputStream {
