...
public class HttpParserTest {
    ...
    private GrizzlyHttpParser httpParser;
    ...
    private void verifyHeaderValue(String name, String... expectedValues) {
        HttpResponse httpResponse = httpParser.getHttpResponse();
        List<String> receivedValues = httpResponse.getHeader(name);
    ...
    private String encodeChunk(String message, int chunkSize, Map<String, String> trailerHeaders) throws UnsupportedEncodingException {
