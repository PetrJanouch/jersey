 ...
 * org.glassfish.jersey.jdk.connector.CompletionHandler)}
...
class TransportFilter extends Filter<ByteBuffer, ByteBuffer, Void, ByteBuffer> {
    ...
    private static final int DEFAULT_CONNECTION_CLOSE_WAIT = 30_000;
    ...
    /**
     * A default thread factory that gets used if {@link org.glassfish.jersey.jdk.connector.ThreadPoolConfig#getThreadFactory()}
     * is not specified.
     */
